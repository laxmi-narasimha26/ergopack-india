 ...
 */
router.get('/', authenticate, authorize('leads.read', '*'), (req, res) => {
  res.json({
    success: true,
    data: [],
 ...
 */
router.post('/', authenticate, authorize('leads.read', '*'), (req, res) => {
  res.status(201).json({
    success: true,
 ...
 */
router.get('/:id', authenticate, authorize('leads.read', '*'), (req, res) => {
  res.json({
    success: true,
    data: null,
 ...
 */
router.put('/:id', authenticate, authorize('leads.read', '*'), (req, res) => {
  res.json({
    success: true,
 ...
 */
router.delete('/:id', authenticate, authorize('leads.read', '*'), (req, res) => {
  res.json({
    success: true,
 ...
 */
router.get('/:id/submissions', authenticate, authorize('leads.read', '*'), (req, res) => {
  res.json({
    success: true,
    data: [],
