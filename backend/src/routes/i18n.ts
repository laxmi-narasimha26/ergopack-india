 ...
 */
router.get('/languages', authenticate, authorize('settings.read', '*'), (req, res) => {
  res.json({
    success: true,
    data: [],
 ...
 */
router.post('/languages', authenticate, authorize('settings.update', '*'), (req, res) => {
  res.status(201).json({
    success: true,
 ...
 */
router.put('/languages/:id', authenticate, authorize('settings.update', '*'), (req, res) => {
  res.json({
    success: true,
 ...
 */
router.delete('/languages/:id', authenticate, authorize('settings.update', '*'), (req, res) => {
  res.json({
    success: true,
 ...
 */
router.get('/content', authenticate, authorize('settings.read', '*'), (req, res) => {
  res.json({
    success: true,
    data: [],
 ...
 */
router.post('/content', authenticate, authorize('settings.update', '*'), (req, res) => {
  res.status(201).json({
    success: true,
 ...
 */
router.delete('/content/:id', authenticate, authorize('settings.update', '*'), (req, res) => {
  res.json({
    success: true,
