 ...
 */
router.put('/:key', authenticate, authorize('settings.update', '*'), (req, res) => {
  res.json({
    success: true,
 ...
 */
router.get('/navigation/menus', authenticate, authorize('settings.read', '*'), (req, res) => {
  res.json({
    success: true,
    data: {},
 ...
 */
router.put('/navigation/:location', authenticate, authorize('settings.update', '*'), (req, res) => {
  res.json({
    success: true,
 ...
 */
router.post('/components', authenticate, authorize('settings.update', '*'), (req, res) => {
  res.status(201).json({
    success: true,
 ...
 */
router.get('/components', authenticate, authorize('settings.read', '*'), (req, res) => {
  res.json({
    success: true,
    data: [],
 ...
 */
router.put('/components/:id', authenticate, authorize('settings.update', '*'), (req, res) => {
  res.json({
    success: true,
