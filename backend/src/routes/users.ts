 ...
 */
router.post('/', authenticate, authorize('users.create', '*'), (req, res) => {
  res.status(201).json({
    success: true,
 ...
 */
router.put('/:id', authenticate, authorize('users.update', '*'), (req, res) => {
  res.json({
    success: true,
 ...
 */
router.get('/roles/list', authenticate, authorize('users.read', '*'), (req, res) => {
  res.json({
    success: true,
    data: [],
 ...
 */
router.put('/:id/role', authenticate, authorize('users.update', '*'), (req, res) => {
  res.json({
    success: true,
 ...
 */
router.put('/:id/deactivate', authenticate, authorize('users.update', '*'), (req, res) => {
  res.json({
    success: true,
