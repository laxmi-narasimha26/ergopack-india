...
export const metadata = {
  ...
  description: 'Premium Lithium-Ion Powered Strapping with Universal Material Compatibility. 1200 cycles per charge, 66 m/min chain speed, Siemens Touchscreen.',
};
