...
export const metadata = {
  ...
  description: 'Professional Mobile Pallet Strapping System with Advanced Lithium-Ion Technology. 1200 cycles, 66 m/min speed, Siemens Touchscreen, Line Laser.',
};
