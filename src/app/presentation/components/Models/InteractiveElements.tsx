  ...
  return (
    <group ref={groupRef} position={position} rotation={rotation}>
      ...
      <mesh>
        ...
        <meshBasicMaterial color="#111111" transparent opacity={0.9} side={THREE.DoubleSide} />
      </mesh>
...
export function Timeline3D({ events, position = [0, 0, 0], color = '#FFB81C' }: Timeline3DProps) {
  const groupRef = useRef<THREE.Group>(null);
  const progressRef = useRef(0);
        ...
        return (
          <group key={i} position={[x, 0, z]}>
            ...
            <mesh position={[0, 0.4, 0]}>
              ...
              <meshStandardMaterial color={product.color} metalness={0.7} roughness={0.3} />
            </mesh>
