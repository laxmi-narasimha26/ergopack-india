...
export function HorizontalShowcase({ active, onSelect }: { active: boolean, onSelect: (id: string) => void }) {
                ...
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2">
                        ...
                        <div className="p-8 md:p-12 bg-white">
                            <h3 className="text-lg font-bold text-gray-900 mb-6 border-b pb-2">Technical Specifications</h3>
