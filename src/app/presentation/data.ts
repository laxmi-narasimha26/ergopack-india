...
export const companyStats = {
  countries: 60,
  years: 27, // Since 1998
  units: '15,000+', // Official from ErgoPack.com
  partners: 30, // Locations in 30+ countries
};

export const timeline = [
  {
    year: '1998',
    event: 'First prototype developed',
    description: 'Double scissors strapping device invented in Lauingen, Germany',
  },
  {
    year: '1999',
    event: 'ChainLance patented',
    description: "World's first ChainLance technology invented and patented",
  },
  {
    year: '2000',
    event: 'ErgoPack 300 launched',
    description: 'First serial model for composite straps, crank operated',
  },
  {
    year: '2002',
    event: 'Gold Medal in Geneva',
    description: 'ErgoPack 600 wins International Exhibition of Inventions gold medal',
  },
  {
    year: '2003',
    event: 'Battery power introduced',
    description: 'Electronic drive and Tool-Lift system development',
  },
  {
    year: '2008',
    event: 'Integrated systems',
    description: 'ErgoPack 720E/730E with integrated sealing head launched',
  },
  {
    year: '2014',
    event: 'ErgoPack Air milestone',
    description: "World's only mobile system for elevated pallets",
  },
  {
    year: '2019',
    event: 'X-pert Line launched',
    description: 'Premium touchscreen systems setting new industry benchmark',
  },
  {
    year: 'Today',
    event: 'India market expansion',
    description: "Serving India's manufacturing elite via Benz Packaging",
  },
];
