...
export default function Compare713Page() {
  const products = [productsData.products['713E'], productsData.products['713X']];
        ...
        <div className="max-w-7xl mx-auto px-8 sm:px-12">
          ...
          <div className="mb-12">
            ...
            <div className="text-center">
              ...
              >
                Compare our ultra-light-duty strapping systems side-by-side. Perfect for delicate packages - discover the performance gap between Economy Line and X-pert Line technology.
              </motion.p>
            </div>
          </div>
          ...
          >
            <div className="premium-card-dark p-6 text-center">
              ...
              <div className="text-platinum-400 text-sm">
                713X: 66 m/min vs 713E: 40 m/min
              </div>
            </div>
            <div className="premium-card-dark p-6 text-center">
              <div className="text-4xl font-serif font-bold bg-gradient-to-r from-amber-400 to-crimson-500 bg-clip-text text-transparent mb-2">
              ...
              <div className="text-platinum-400 text-sm">
                713X: 1200 cycles vs 713E: 350 cycles
              </div>
            </div>
            <div className="premium-card-dark p-6 text-center">
              <div className="text-4xl font-serif font-bold bg-gradient-to-r from-amber-400 to-crimson-500 bg-clip-text text-transparent mb-2">
