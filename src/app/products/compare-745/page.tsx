...
export default function Compare745Page() {
  const products = [productsData.products['745E'], productsData.products['745X']];
        ...
        <div className="max-w-7xl mx-auto px-8 sm:px-12">
          ...
          <div className="mb-12">
            ...
            <div className="text-center">
              ...
              >
                Compare our medium/heavy-duty strapping systems side-by-side. Economy Line reliability vs X-pert Line performance - see the differences that matter.
              </motion.p>
            </div>
          </div>
          ...
          >
            <div className="premium-card-dark p-6 text-center">
              ...
              <div className="text-platinum-400 text-sm">
                745X: 66 m/min vs 745E: 40 m/min
              </div>
            </div>
            <div className="premium-card-dark p-6 text-center">
              <div className="text-4xl font-serif font-bold bg-gradient-to-r from-amber-400 to-crimson-500 bg-clip-text text-transparent mb-2">
              ...
              <div className="text-platinum-400 text-sm">
                745X: 1200 cycles vs 745E: 350 cycles
              </div>
            </div>
            <div className="premium-card-dark p-6 text-center">
              <div className="text-4xl font-serif font-bold bg-gradient-to-r from-amber-400 to-crimson-500 bg-clip-text text-transparent mb-2">
