...
export default function ImageHeroSection() {
    return (
        <section className="relative min-h-screen w-full overflow-hidden bg-black">
            ...
            <div className="relative z-10 min-h-screen flex flex-col justify-center px-6 md:px-16 lg:px-24 pt-24 pb-16 md:pb-48">
                <div className="max-w-3xl">
                    ...
                    >
                        The world&apos;s most advanced ergonomic pallet strapping systems. Trusted by 55+ countries worldwide.
                    </motion.p>
            ...
            {/* Bottom Feature Bar - Hidden on mobile, shown on tablet+ */}
            <div className="absolute bottom-16 md:bottom-24 left-0 z-20 w-full px-6 md:px-16 pointer-events-none hidden md:block">
                <motion.div
                    initial={{ opacity: 0, y: 30 }}
                    animate={{ opacity: 1, y: 0 }}
                ...
                >
                    <div className="w-full grid grid-cols-4 gap-8 md:gap-12 border-t border-white/10 pt-8 backdrop-blur-sm bg-black/20 rounded-t-2xl px-6">
                        {[
                            ...
                            >
                                <div className="p-3 rounded-full bg-white/5 border border-white/10 group-hover:border-[#C8102E]/50 transition-colors duration-300">
                                    <item.Icon className="w-6 h-6 text-[#C8102E]" strokeWidth={1.5} />
                                </div>
                                <div>
