...
export const machines: MachineModel[] = [
  // X-pert Line Models
  {
    ...
    specifications: {
      control: {
        ...
        xpert: 'Electronic Control',
        economy: 'Manual/Semi-Auto',
        highlight: 'xpert',
      },
      positioning: {
        label: 'Positioning System',
        xpert: 'Precision Guides',
        economy: 'Visual Guides',
        highlight: 'xpert',
      },
      lift: {
        label: 'Lifting Mechanism',
        xpert: 'Tool-Lift System',
        economy: 'Standard Mechanical',
        highlight: 'xpert',
      },
      tension: {
        label: 'Max Tension Force',
        xpert: 4500,
        economy: 4500,
        unit: 'N',
        highlight: 'both',
      ...
      mechanism: {
        ...
        xpert: 'Advanced Electronic',
        economy: 'Proven Mechanical',
        highlight: 'xpert',
      },
      strapWidth: {
        label: 'Strap Width Range',
        xpert: '16-19mm',
        economy: '16-19mm',
        highlight: 'both',
      },
      power: {
        label: 'Battery Type',
        xpert: 'Lithium-Ion 24V',
        economy: 'Lead-Fleece 24V',
        highlight: 'xpert',
      },
      monitoring: {
      ...
      temperature: {
        ...
        xpert: '-20°C to +60°C',
        economy: '-20°C to +50°C',
        highlight: 'xpert',
      },
      certification: {
        label: 'Certifications',
        xpert: 'ISO 12100, AGR, EU',
        economy: 'ISO 12100, EU',
        highlight: 'xpert',
      },
      warranty: {
      ...
      idealFor: {
        ...
        xpert: 'High-Volume Heavy-Duty',
        economy: 'Standard Heavy-Duty',
        highlight: 'none',
      },
    },
  },
  {
    ...
    specifications: {
      ...
      idealFor: {
        label: 'Best Suited For',
        xpert: 'High-Volume Light-Duty',
        economy: 'Standard Light-Duty',
        highlight: 'none',
      },
    },
  },
  {
    ...
    specifications: {
      ...
      idealFor: {
        label: 'Best Suited For',
        xpert: 'High-Volume Ultra-Light',
        economy: 'Standard Ultra-Light',
        highlight: 'none',
      },
    },
  },
  {
    ...
    specifications: {
      ...
      positioning: {
        label: 'Positioning System',
        xpert: 'Fixed Position',
        economy: 'Fixed Position',
        highlight: 'both',
      },
      lift: {
        label: 'Lifting Mechanism',
        xpert: 'Mounted System',
        economy: 'Manual System',
        highlight: 'xpert',
      },
      tension: {
        label: 'Max Tension Force',
      ...
      idealFor: {
        label: 'Best Suited For',
        xpert: 'Fixed Station High-Volume',
        economy: 'Fixed Station Standard',
        highlight: 'none',
      },
    },
  },
...
export const getMachineById = (id: string) => machines.find((m) => m.id === id);
